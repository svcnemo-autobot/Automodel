...
<Button small outlined href="/recipes-e2e-examples/retrieval-finetune">🔎 Retrieval</Button>
...
| **Embedding fine-tune**     | You want to improve text similarity for search, retrieval, or RAG                  | Text pairs / retrieval corpus                     | LLM       | [Fine-tune retrieval](/recipes-e2e-examples/retrieval-finetune) |
